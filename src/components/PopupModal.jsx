...
const PopupModal = ( {showModal, selectedMovie, setShowModal, movieIdInfo, movieVideoInfo} ) => {
  ...
  return (
    ...
    <div className={`popup ${showModal ? "visible" : "notVisible"}`}>
            ...
            {video.length && <iframe width="560" height="315" src={`https://www.youtube.com/embed/${video[0].key}`} title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>}            <p>Run Time: {movieIdInfo.runtime} minutes</p>
            <p>Genres: {genres} </p>
